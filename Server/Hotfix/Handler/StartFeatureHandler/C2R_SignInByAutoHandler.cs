...
namespace ETHotfix
{
    ...
    //public class C2R_SignInByAutoHandler : AMRpcHandler<C2R_SignInByAuto, R2C_SignIn>
    //{
    //    protected override void Run(Session session, C2R_SignInByAuto message, Action<R2C_SignIn> reply)
    //    {
    //        RunAsync(session, message, reply).Coroutine();
    //    }

    //    private async ETVoid RunAsync(Session session, C2R_SignInByAuto message, Action<R2C_SignIn> reply)
    //    {
    ...
    //                    await SignInHelper.RealmToGate(session, user, response, false);
    //                }
    //            }
    //            else
    //            {
