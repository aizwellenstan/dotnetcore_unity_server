...
namespace ETHotfix
{
    ...
    public class C2G_TeamReservationCreateHandler : AMRpcHandler<C2G_TeamReservationCreate, G2C_TeamReservationCreate>
    {
        protected override void Run(Session session, C2G_TeamReservationCreate message, Action<G2C_TeamReservationCreate> reply)
        {
