...
namespace ETModel
{
	...
	public class HttpComponent : Component
	{
			...
			switch (context.Request.HttpMethod)
			{
				...
				case "POST":
					...
					if (methodInfo != null)
					{
                        ...
                        var a = ToPostByteArray(context.Request.ContentEncoding, GetBoundary(context.Request.ContentType), context.Request.InputStream);

						File.WriteAllBytes(@"C:\Users\ethan\Desktop\bbb.png", a);
        ...
        private static byte[] ToPostByteArray(Encoding enc, string boundary, Stream input)
        {
